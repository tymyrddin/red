...
Because BGP is the rickety Victorian plumbing of the internet. It is still doing the job, but full of leaky joints, no authentication by default, and everyone
pretending it is fine until the pipes burst. It can give:

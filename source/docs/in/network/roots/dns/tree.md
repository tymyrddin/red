...
| 1.2.2.2 Large RRSIG reflection attacks                       | Medium               | Medium             | High       | Exploits oversized signed responses; best mitigated by response size limits and egress filtering.    |
...
| 2.2.3.2 Enterprise firewall policy enforcement               | Low                  | Low                | Medium     | Localized blocking/inspection; limited to enterprise boundaries.                                     |
...
| 6.2.1.1 Photon-splitting attacks                             | Very High            | Very High          | Medium     | Specialized QKD attack; requires physical access and lab gear.                                       |

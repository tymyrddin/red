...
| 5.1.3.1 Reinforcement learning for evasion                   | Very High            | High               | High       | Trains agents to adapt queries against defences; research-heavy.                                     |
| 5.1.3.2 Genetic algorithm optim                       | High                 | Medium             | Medium     | Evolves traffic features to reduce detection scores.                                                 |
...
| 5.3.1.3 Reinforcement learning for policy exploitation       | Very High            | High               | High       | Probes defences to discover blind spots automatically.                                               |
...
| 7.1.1.1 Traditional DNS (TXT, NULL records)                  | Low                  | Low                | Medium     | Simple tunneling via classic records; widely detected by mature defences.                            |

...
| RPKI (ROA - Route Origin Authorisation) | A cryptographic framework where prefix owners sign which ASN(s) are authorised to originate them.                  | Allows routers to validate BGP announcements and reject hijacked routes. |

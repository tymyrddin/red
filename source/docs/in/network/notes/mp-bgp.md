...
## Key MP-BGP concepts and terminology
...
## Comparing classic BGP and MP-BGP
...
## Common MP-BGP address families (AFI/SAFI)
...
- Considerations:
  - Policy Complexity: route-maps and filtering policies are applied per address family, increasing configuration complexity.
...
## MP-BGP for IPv6 implementation
...
- Configuration involves two steps:
  ...
  2. Activate the IPv6 neighbour under that address family.

## Key related protocols and technologies

...
2FA simple bypass is the variant in play. Rate limiting, MFA, and uniform failure messages are the levers. Defenders' notes on this are under [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).

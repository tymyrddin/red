...
Password reset poisoning via middleware is the case here. Rate limiting, MFA, and uniform failure messages are the levers. Defenders' notes on this are under [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).

...
Blind SSRF with out-of-band detection is what this page works through. Allow-listing outbound destinations and blocking the metadata endpoint are the counters. The defender's view is in the blue notes on [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).

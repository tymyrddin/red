...
Clickjacking with a frame buster script is what this page works through. Frame-ancestors in CSP, or X-Frame-Options, are the standard defence. Seen from the other side, this sits in the blue notes on [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).

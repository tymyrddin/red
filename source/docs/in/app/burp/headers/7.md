...
Password reset poisoning via dangling markup is what this page works through. Stripping revealing headers and setting the right security headers are the fix. Defenders' notes on this are under [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).

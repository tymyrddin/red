...
File path traversal, traversal sequences stripped non-recursively is what this page works through. Canonicalising paths and confining access to an allow-listed root close it. The defender's view is in the blue notes on [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).

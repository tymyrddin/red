...
Server-side template injection in an unknown language with a documented exploit is what this page works through. Keeping user input out of templates and sandboxing the engine close it. The defensive counterpart is in the blue notes on [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).

...
SameSite Lax bypass via method override is the case here. Anti-CSRF tokens and SameSite cookies are the standard defence. Seen from the other side, this sits in the blue notes on [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).

...
DOM-based cookie manipulation is what this page works through. Avoiding dangerous sinks and using safe DOM APIs are the answer. The defensive counterpart is in the blue notes on [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).

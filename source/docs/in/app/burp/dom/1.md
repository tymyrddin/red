...
DOM XSS using web messages is the variant in play. Avoiding dangerous sinks and using safe DOM APIs are the answer. The defensive counterpart is in the blue notes on [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).

...
Exploiting XXE to perform SSRF attacks is what this page works through. Disabling external entities and DTD processing in the parser removes it. The defensive counterpart is in the blue notes on [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).

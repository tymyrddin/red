...
Exploiting XXE via image file upload is what this page works through. Disabling external entities and DTD processing in the parser removes it. The defender's view is in the blue notes on [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).

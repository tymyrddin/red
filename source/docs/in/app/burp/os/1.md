...
OS command injection, simple case is the variant in play. Avoiding the shell and passing arguments as data, never building command strings, is the fix. Defenders' notes on this are under [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).

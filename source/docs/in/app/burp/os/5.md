...
Blind OS command injection with out-of-band data exfiltration is what this page works through. Avoiding the shell and passing arguments as data, never building command strings, is the fix. Defenders' notes on this are under [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).

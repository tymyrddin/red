...
Client-side prototype pollution via browser APIs is what this page works through. Strict parameter parsing, and not merging untrusted input into object prototypes, close it. Seen from the other side, this sits in the blue notes on [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).

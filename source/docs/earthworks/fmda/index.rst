...
Beneath spore-laden :doc:`Fungolian <../fungolia>` government halls, FMDA allocates
IPs, manages spectrum, and monitors compliance, all the while public portals and legacy networks quietly invite
exploration.
...
.. toctree::
   ...
   :maxdepth: 1
   :includehidden:
   :caption: Bureaucracy underground, oversight aboveground, misconfigurations everywhere.

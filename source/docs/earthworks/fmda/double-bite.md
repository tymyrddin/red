...
The VPN exploitation surface is modelled in [Rootways: IPsec](../../in/network/roots/ipsec/index.rst). Network traversal procedures are in [Tradecraft: lateral movement](../../in/network/runbooks/lateral-movement.md).
...
the visible destruction serves only to hide the theft. Looking only at the smoke misses the reason for the fire.

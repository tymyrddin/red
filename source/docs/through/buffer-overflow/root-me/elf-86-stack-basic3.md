...
Here the overflow redirects into chosen code. ASLR makes the target address hard to predict. Defenders' notes on this are under [memory corruption and its limits](https://blue.tymyrddin.dev/docs/counter/memory/).

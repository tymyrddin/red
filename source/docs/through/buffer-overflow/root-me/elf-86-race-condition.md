...
A race between check and use opens a window to exploit. Proper locking and atomic operations close it. Defenders' notes on this are under [memory corruption and its limits](https://blue.tymyrddin.dev/docs/counter/memory/).

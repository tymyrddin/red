...
A zero-protection PE reads straight through. Stripping and packing are the cheap first steps. The defensive counterpart is in the blue notes on [the application layer as a target](https://blue.tymyrddin.dev/docs/counter/app/).
